...
public class AccountRulesEngine {
    ...
    public static double getSavingsMinBalance(int tenureYears) {
        return SAVINGS_MIN_BALANCES.getOrDefault(getSavingsBucket(tenureYears), 10000.0);
    }

    public static double getSavingsInterestRate(int tenureYears) {
        return SAVINGS_INTEREST_RATES.getOrDefault(getSavingsBucket(tenureYears), 2.70);
    }
