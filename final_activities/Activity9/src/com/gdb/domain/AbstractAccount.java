...
public abstract class AbstractAccount {
    ...
    public AbstractAccount(String accountNumber, String name, int age, double balance,
    ...
    // Template Method: the sequence is fixed here; debit policy is supplied by subclasses.
